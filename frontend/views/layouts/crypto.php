                        ...
                        <ul class="dropdown-menu scale-up">
                            ...
                            <li class="user-body">
                                <div class="row no-gutters">
                                    ...
                                    <div role="separator" class="divider col-12"></div>
                                    <div class="col-12 text-left">
                                        <?= Html::a('<i class="fa fa-power-off"></i> Logout',['site/logout']) ?>
                                    </div>
                                </div>
                                <!-- /.row -->
                            </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active">
                    <?= Html::a('<i class="icon-home"></i> <span>Dashboard</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i></span>',['site/index'])?>
                    <a href="index.html">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <li class="treeview">
                    <?= Html::a('<i class="icon-key"></i><span>Login</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-right pull-right"></i></span>',['site/login']) ?>
                    </li>
                <li class="treeview">
                    <a href="#">
